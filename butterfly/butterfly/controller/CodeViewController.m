...
- (void)viewDidLoad
{
    ...
    UIImageView * imageView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 100, 320, 300)];
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if ([metadataObjects count] >0)
    {
        ...
        homeVC.webview_url = stringValue;
        homeVC.main_title = @"test";
        //        NSURL *url = [NSURL URLWithString:stringValue];
        //        stringValue == @"http://vip.qq.com";
        //        NSURL *url = [NSURL URLWithString:@"http://vip.qq.com"];
        //        NSURLRequest *request = [NSURLRequest requestWithURL:url];
        //        [homeVC.mainWebview loadRequest:request];
        //        [homeVC.mainWebview reload];
        //        NSLog(@"%@",homeVC.mainWebview);
