...
- (void)viewDidLoad
{
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleBordered target:self action:@selector(cancel:)];
    
    self.navigationItem.title = @"二维码扫描";
    self.navigationItem.rightBarButtonItem = barButtonItem;
    self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:36.0f/255.0f green:49.0f/255.0f blue:58.0f/255.0f alpha:255.0f];
    
    [barButtonItem release];
    
    activeIndicator = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 24.0f, 24.0f)];
    [activeIndicator setCenter:CGPointMake([UIScreen mainScreen].bounds.size.width / 2, [UIScreen mainScreen].bounds.size.height / 2 - 64)];
    ...
    label = [[UILabel alloc] initWithFrame:theRect];
    label.textAlignment = UITextAlignmentCenter;
    label.backgroundColor = [UIColor clearColor];
    label.font = [UIFont fontWithName:@"Verdana" size:14];
    label.text = @"准备中";
    label.textColor = [UIColor colorWithRed:62.0f/255.0f green:78.0f/255.0f blue:97.0f/255.0f alpha:255.0f];
    label.tag = 100;
